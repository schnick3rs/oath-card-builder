...
export default {
  name: "index",
  layout: 'print',
  components: {DenizenCard, RelicCard},
  data() {
    return {
      denizens: [
        {
      ...
      relics: [
        ...
        {
          name: 'Amulet of conjunction',
          image: 'https://www.vhv.rs/dpng/f/543-5437638_magical-png.png',
          defense: 4,
          type: 'power',
          cost: '12!@',
